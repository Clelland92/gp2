...
bool CGameApplication::initGraphics()
{
	...
	UNIT width=windowRect.right-windowRect.left;
	UNIT height=windowRect.bottom-windowRect.top;
	UNIT createDeviceFlags=0;

#ifdef_DEBUG
	createDeviceFlags|=D3D10_CREATEDEVICE_DEBUG;
#endif
